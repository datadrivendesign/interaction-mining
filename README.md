...
For detailed setup instructions for the full project (i.e. MongoDB and storage configuration), please visit:  
**https://interactionmining.org/contribute**

**To directly start the NextJS application:**
...
2. Set up your environment variables (see `.env.example` or the project website for required variables).
