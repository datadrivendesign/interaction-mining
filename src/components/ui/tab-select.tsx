...
const TabSelect = TabsPrimitive.Root

const TabSelectList = React.forwardRef<
...
TabSelectList.displayName = TabsPrimitive.List.displayName

const TabSelectTrigger = React.forwardRef<
...
TabSelectTrigger.displayName = TabsPrimitive.Trigger.displayName

export { TabSelect, TabSelectList, TabSelectTrigger }
