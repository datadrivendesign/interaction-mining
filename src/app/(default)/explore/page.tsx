    ...
    <GalleryRoot>
      <main className="relative flex flex-col grow min-h-dvh items-center justify-between">
        <section className="relative flex flex-col w-full max-w-(--breakpoint-2xl)">
          <div className="sticky top-16 z-40 flex flex-col md:flex-row p-4 lg:p-6 gap-x-4 lg:gap-x-6 items-start md:justify-between md:items-center bg-white dark:bg-black border-b-2 border-neutral-100 dark:border-neutral-900">
