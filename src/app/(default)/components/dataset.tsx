...
export default function Dataset() {
  return (
    ...
    >
      <div className="flex col-span-1 row-span-1 lg:row-span-2 w-full h-full p-px bg-gradient-to-br from-neutral-800 to-neutral-900 rounded-3xl">
        <div className="flex flex-col w-full h-full p-6 bg-gradient-to-br from-neutral-900 to-black rounded-[calc(1.5rem-1px)] overflow-hidden">
          ...
          <div className="relative z-0 w-full min-h-36">
            <Globe className="absolute z-0 object-cover w-full lg:w-[150%] h-auto" />
          </div>
        </div>
      </div>
      <div className="flex order-first lg:order-none col-span-1 md:col-span-2 grow w-full h-full p-px bg-gradient-to-br from-neutral-800 to-neutral-900 rounded-3xl lg:-translate-y-1/4">
        <div className="flex flex-col items-start justify-start w-full h-full p-6 bg-gradient-to-br from-neutral-900 to-black rounded-[calc(1.5rem-1px)]">
          <DatasetGallery />
        </div>
      </div>
      <div className="flex col-span-1 w-full p-px bg-gradient-to-br from-neutral-800 to-neutral-900 rounded-3xl aspect-1/1 lg:-translate-y-1/4">
        <div className="flex flex-col items-start justify-start w-full h-full p-6 bg-gradient-to-br from-neutral-900 to-black rounded-[calc(1.5rem-1px)]">
