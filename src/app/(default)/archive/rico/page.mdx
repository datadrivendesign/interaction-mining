...
<div className="grid grid-cols-3 w-full not-prose mt-8 gap-6">
  ...
  <div className="flex flex-col grow col-span-2">
    <Card className="h-full">
      <CardContent className="text-base grow">
        Thomas F. Liu, Mark Craft, Jason Situ, Ersin Yumer, Radomir Mech, Ranjitha Kumar. 2018. <span className="font-bold">Learning Design Semantics for Mobile Apps</span>. In Proceedings of the 31st <span className="italic">Annual Symposium on User Interface Software and Technology (UIST&nbsp;2018)</span>. 
...
<Card className="mt-8 gap-0">
  ...
  <CardContent>
    ...
    2. [UI Metadata (2 MB)](https://storage.googleapis.com/crowdstf-rico-uiuc-4540/rico_dataset_v0.1/ui_details.csv)
    3. [UI Layout Vectors (8 MB)](https://storage.googleapis.com/crowdstf-rico-uiuc-4540/rico_dataset_v0.1/ui_layout_vectors.zip)
    4. [Interaction Traces (6 GB)](https://storage.googleapis.com/crowdstf-rico-uiuc-4540/rico_dataset_v0.1/traces.tar.gz)
    5. [Animations (214 GB)](https://storage.googleapis.com/crowdstf-rico-uiuc-4540/rico_dataset_v0.1/animations.tar.gz)
    6. [Play Store Metadata (2 MB)](https://storage.googleapis.com/crowdstf-rico-uiuc-4540/rico_dataset_v0.1/app_details.csv)
    7. [UI Screenshots and Hierarchies with Semantic Annotations (150 MB)](https://storage.googleapis.com/crowdstf-rico-uiuc-4540/rico_dataset_v0.1/semantic_annotations.zip)
  </CardContent>
