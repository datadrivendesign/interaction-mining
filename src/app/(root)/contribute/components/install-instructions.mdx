...
#### Recording a Trace
1. Navigate to the user dashboard where existing captures and tasks are listed.  
...
5. Open the ODIM Android app and scan this QR code. The app will auto-link the task and prepare the environment to begin interaction capture.  
